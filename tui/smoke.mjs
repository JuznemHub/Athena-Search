...
try {
  ...
  writeFileSync(html, `<DL><p><DT><H3>Dev</H3><DL><p><DT><A HREF="https://ex.org">Ex</A></DL><p><DT><A HREF="https://plain.org">Plain</A></DL><p><DT><A HREF="https://xss.org"><script>alert(1)</script>Evil<img src=x>&amp;lt;script&amp;gt;&#x3c;script&#x3e;&#60;b&#62;</A>`);
  ...
  const safe = xss?.title.includes('alert(1)') && xss?.title.includes('Evil') && !/[<>]/.test(xss?.title) && !/&#/.test(xss?.title);
